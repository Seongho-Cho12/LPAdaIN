...
decoder = nn.Sequential(
    ...
    nn.Conv2d(256, 256, (3, 3)),
    nn.ReLU(),
    nn.ReflectionPad2d((1, 1, 1, 1)),   # 13th, for 3 depth
    ...
    nn.ReLU(),
    nn.ReflectionPad2d((1, 1, 1, 1)),   # 20th, for 2 depth
    ...
    nn.Conv2d(64, 64, (3, 3)),
    nn.ReLU(),
    nn.ReflectionPad2d((1, 1, 1, 1)),   # 27th, for 1 depth
    nn.Conv2d(64, 3, (3, 3)),
)
